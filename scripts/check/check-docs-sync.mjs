...
// If required docs haven't been created yet for this project tree, skip all checks.
if (!fs.existsSync(openApiPath) || !fs.existsSync(changelogPath)) {
  console.log("[docs-sync] SKIP - docs/openapi.yaml and/or CHANGELOG.md not present in this tree.");
  process.exit(0);
}
